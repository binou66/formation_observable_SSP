...
const donneesFiltrees = meteo_31_2023_2024_extrait.filter(d => d.nom_poste === "MONTESQUIEU-LAURAGAIS");

// Créer un graphique combiné pour temp_min et temp_max
const graphiqueTemp = Plot.plot({
  title: "Températures minimales et maximales pour Montesquieu-Lauragais",
...
<div class="grid grid-cols-1">
  <div class="card">
    ${resize((width) => launchTimeline(donneesFiltrees, {width}))}
  </div>
</div>
